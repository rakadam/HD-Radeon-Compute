...
MEM_RAT:
        RAT_ID(11) RAT_INST.EXPORT_RAT_INST_ADD TYPE(3) INDEX_GPR(5) RW_GPR(0);
        COMP_MASK(15) BARRIER MARK;
WAIT_ACK: BARRIER;
MEM_RAT:
        RAT_ID(11) RAT_INST.EXPORT_RAT_INST_ADD TYPE(3) INDEX_GPR(6) RW_GPR(0);
        COMP_MASK(15) BARRIER MARK;
WAIT_ACK: BARRIER;
MEM_RAT:
        RAT_ID(11) RAT_INST.EXPORT_RAT_INST_ADD TYPE(3) INDEX_GPR(7) RW_GPR(0);
        COMP_MASK(15) BARRIER MARK;
WAIT_ACK: BARRIER;
MEM_RAT:
        RAT_ID(11) RAT_INST.EXPORT_RAT_INST_ADD TYPE(3) INDEX_GPR(8) RW_GPR(0);
        COMP_MASK(15) BARRIER MARK;
WAIT_ACK: BARRIER;

// MEM_RAT_CACHELESS:
//         RAT_ID(11) TYPE(1) RW_GPR(0) INDEX_GPR(5) ELEM_SIZE(0);
//         COMP_MASK(15) BARRIER VALID_PIXEL_MODE ARRAY_SIZE(0) MARK;
